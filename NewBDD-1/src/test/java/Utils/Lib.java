...
public class Lib {
	...
	public static String readproperties(WebDriver driver, String key) throws IOException {
		...
		InputStream fs = new FileInputStream(
				"C:\\Users\\Aney\\Documents\\JavaProject2018\\NewBDD-1\\src\\test\\resouces\\ObjectRepository\\Locator.properties");
	...
	public static void takescreenshot(WebDriver driver, String a) throws IOException {
		...
		FileUtils.copyFile(src, new File("C:\\Users\\INSTRUCTOR\\eclipse-workspace\\maven2\\" + a + "error.png"));
	}
