...
public class Lib {
	...
	public static String readproperties(WebDriver driver, String key) throws IOException {
		...
		InputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\resources\\ObjectRepository\\locator.properties");
	...
	public static void takescreenshot(WebDriver driver, String a) throws IOException {
		...
		FileUtils.copyFile(src, new File("C:\\Users\\Aney\\Google Drive\\PNT2018\\My class\\Selenium\\Screenshot" + a + "error.png"));
	}
