...
//		Go to the Web Address 
		...
		if(selection) {
			System.out.println(driver.findElement(By.xpath("//label[contains(text(),'Female')]")).getText() + " is selected");
		}else {
			System.out.println(driver.findElement(By.xpath("//label[contains(text(),'Female')]")).getText() +" is not selected");
		}
		
		driver.navigate().to("https://www.amazon.com/");
		
//		driver.findElement(By.cssSelector("input[id='twotabsearchtextbox']")).sendKeys("The art of the deal");
//		
